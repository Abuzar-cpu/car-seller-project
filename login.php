...
<div class="container-fluid d-flex justify-content-center align-items-center my-auto" id="log-in-page-main">
    <div class="w-50 text-center">
        <form action="./php_files/doLogin.php" method="post">
            ...
            <input id="log-in-button" type="submit" name="submit" value="Log in" class="mt-3 w-50 btn btn-primary"/>
<!--            <label style="color: white" for="show-pass">Show Password</label>-->
<!--            <input type="checkbox" id="show-pass"/>-->

            <div><h5 class="p-3 mt-3" id="login-notification" style="color: white; background-color: red"><?php echo $msg ?></h5></div>
        </form>
    </div>
</div>
